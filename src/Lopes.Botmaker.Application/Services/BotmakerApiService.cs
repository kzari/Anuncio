    ...
    public class BotmakerApiService : IBotmakerApiService
    {
        ...
        public IResultado<IEnumerable<UsuarioBotmakerApi>> ObterUsuariosNaBotmaker()
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                //return ExecResult<IEnumerable<UsuarioBotmakerApi>>.WithError(mensagem);
            }
            ...
            return new Retorno<IEnumerable<UsuarioBotmakerApi>>(root.active);
        }

        //public IExecResult RemoverUsuarioChatbox(string email)
        //{
        //    var content = new FormUrlEncodedContent(new List<KeyValuePair<string, string>> { });
        ...
        //    if (response.IsSuccessStatusCode)
        //    {
        //        return ExecResult.WithSuccess;
        //    }
        //    else
        //    {
        //        string mensagem = TratarResponse(response);
        //        return ExecResult.WithError(mensagem);
        //    }
        //}

        //public IExecResult AtualizarUsuarioChatbox(BotmakerInserirAtualizarUsuario item)
        //{
        //    var content = new FormUrlEncodedContent(new List<KeyValuePair<string, string>>());
        ...
        //public IExecResult<string> ObterTokenDeAcesso(string email)
        //{
        //    var content = new FormUrlEncodedContent(new List<KeyValuePair<string, string>>());
        //    content.Headers.Add("email", email);
        ...
        //        return ExecResult<string>.WithSucess(token.token);
        //    }
        //    else
        //    {
        //        string mensagem = TratarResponse(response);
        //        return ExecResult<string>.WithError(mensagem);
        //    }
        //}
        ...
        //private string TratarResponse(HttpResponseMessage response)
        //{
