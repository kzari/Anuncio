IF(OBJECT_ID('dbo.VW_ImovelImagensAnuncio', 'V') IS NOT NULL)
	DROP VIEW dbo.VW_ImovelImagensAnuncio
GO
-- Imagens/Fotos dos imóveis para os anúncios/site
CREATE VIEW dbo.VW_ImovelImagensAnuncio
AS
	 SELECT 
...
GO
		...
		select * from VW_ImovelImagensAnuncio where idimovel = 7502
